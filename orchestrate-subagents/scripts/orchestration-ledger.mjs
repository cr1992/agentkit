...
function validateNodeVerification(input, contract) {
  ...
  if (!['worker_self_check', 'controller_recheck', 'independent_evidence'].includes(value.requirement)) throw new LedgerError('verification requirement 无效');
