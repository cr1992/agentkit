...
// 直接执行时行为与 domains/orchestrate/orchestration-reflection.mjs 逐字节一致；被 import 时只透传导出。
import { forwardLegacyEntry } from '../../core/legacy-entry.mjs';
import { runCli } from '../../domains/orchestrate/orchestration-reflection.mjs';

export * from '../../domains/orchestrate/orchestration-reflection.mjs';
