...
// 直接执行时行为与 domains/orchestrate/host_capability_cache.mjs 逐字节一致；被 import 时只透传导出。
import { forwardLegacyEntry } from '../../core/legacy-entry.mjs';
import { runCli } from '../../domains/orchestrate/host_capability_cache.mjs';

export * from '../../domains/orchestrate/host_capability_cache.mjs';
