...
export function buildSelftestScript() {
  return [
    ...
    'grep -qF "| 永远 NONE | 0/21 | 12/12 |" /out/selftest/replay-none/report.md',
    'grep -qF "| 正向 | 0/21 |" /out/selftest/replay-none/report.md',
    'grep -qF "| 正向 | 6/21 |" /out/selftest/replay-write/report.md',
