...
const RUNTIME_SCRIPT_PATH = join(SKILL_ROOT, 'scripts', 'verification-runtime.mjs');
...
function falsificationTask() {
  const text = readFileSync(join(SKILL_ROOT, 'references', 'verification-protocol.md'), 'utf8');
